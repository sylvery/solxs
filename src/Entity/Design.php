...
class Design
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=DesignCategory::class, inversedBy="designs")
     */
    private $category;
    ...
    public function getCategory(): ?DesignCategory
    {
        return $this->category;
    }

    public function setCategory(?DesignCategory $category): self
    {
